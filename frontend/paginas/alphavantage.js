...
const fetchQuote = async () => {
  ...
  try {
    const resp = await getJson(`/alphavantage/quote?symbol=${encodeURIComponent(symbol)}`);
...
const fetchSearch = async () => {
  ...
  try {
    const resp = await getJson(`/alphavantage/search?keywords=${encodeURIComponent(kw)}`);
...
const fetchDaily = async () => {
  ...
  try {
    const resp = await getJson(`/alphavantage/daily?symbol=${encodeURIComponent(symbol)}&outputsize=${encodeURIComponent(size)}`);
...
const fetchFxDaily = async () => {
  ...
  try {
    const resp = await getJson(`/alphavantage/fx-daily?from=${encodeURIComponent(from)}&to=${encodeURIComponent(to)}`);
...
const fetchSma = async () => {
  ...
  try {
    const resp = await getJson(`/alphavantage/sma?symbol=${encodeURIComponent(symbol)}&interval=${encodeURIComponent(interval)}&time_period=${encodeURIComponent(period)}&series_type=${encodeURIComponent(series)}`);
...
const fetchRsi = async () => {
  ...
  try {
    const resp = await getJson(`/alphavantage/rsi?symbol=${encodeURIComponent(symbol)}&interval=${encodeURIComponent(interval)}&time_period=${encodeURIComponent(period)}&series_type=${encodeURIComponent(series)}`);
...
const fetchOverview = async () => {
  ...
  try {
    const resp = await getJson(`/alphavantage/overview?symbol=${encodeURIComponent(symbol)}`);
