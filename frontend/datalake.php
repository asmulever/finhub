        ...
        <div class="tab-panel active" id="tab-catalog" style="margin-top:12px;">
          <div class="section-grid">
            <div class="block">
              ...
              <p class="muted">Consulta, edita o sincroniza el catálogo (solo Admin).</p>
              <div class="actions" style="margin:8px 0;">
                <input id="catalog-search" placeholder="Filtrar por símbolo o nombre" />
                ...
                <button id="catalog-sync" class="primary" type="button">Sincronizar RAVA</button>
              </div>
              <div class="table-wrapper">
                <table>
                  ...
                  <tbody id="catalog-body">
                    <tr><td class="muted" colspan="8">Cargando...</td></tr>
                  </tbody>
                </table>
              </div>
            </div>
            <div class="block">
              <div class="alert">Advertencia: editar/eliminar puede afectar integridad. Confirma antes de guardar.</div>
              <h3 style="margin-top:10px;">Editar / Crear</h3>
              <div class="form-grid" style="margin-top:8px;">
                <input id="form-symbol" placeholder="Símbolo (OBLIGATORIO)" />
                ...
                <input id="form-market" placeholder="Mercado/Panel" />
                <input id="form-currency" placeholder="Moneda" />
                <input id="form-price" placeholder="Precio" />
                <input id="form-asof" placeholder="As of (ISO)" />
              </div>
              <div class="actions" style="margin-top:10px;">
                <button id="form-save" class="primary" type="button">Guardar</button>
                <button id="form-delete" class="danger" type="button">Eliminar</button>
