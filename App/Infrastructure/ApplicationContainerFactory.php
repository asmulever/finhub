...
final class ApplicationContainerFactory
{
    public static function create(): Container
    {
        ...
        $container->set(CronSecretValidator::class, fn(Container $c) => new CronSecretValidator(
            $c->get(LogService::class)
        ));
        $container->set(RunEtlJobUseCase::class, fn(Container $c) => new RunEtlJobUseCase(
        ...
        $container->set(GetEtlStatusUseCase::class, fn(Container $c) => new GetEtlStatusUseCase(
            $c->get(EtlRunLogRepositoryInterface::class)
        ));
        ...
        $container->set(EtlController::class, fn(Container $c) => new EtlController(
            $c->get(RunEtlJobUseCase::class),
            $c->get(CronSecretValidator::class),
            $c->get(GetEtlStatusUseCase::class)
        ));
